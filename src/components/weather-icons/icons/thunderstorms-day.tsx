...
const SvgThunderstormsDay = (props: any) => (
  ...
  >
    <defs>
      <symbol id="thunderstorms-day_svg__c" viewBox="0 0 196 196">
        <circle
          ...
          cy={98}
          r={40}
          fill="url(#thunderstorms-day_svg__a)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol id="thunderstorms-day_svg__d" viewBox="0 0 350 222">
        <path
          fill="url(#thunderstorms-day_svg__b)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol id="thunderstorms-day_svg__g" viewBox="0 0 363 258">
        <use xlinkHref="#thunderstorms-day_svg__c" width={196} height={196} />
        <use
          xlinkHref="#thunderstorms-day_svg__d"
          width={350}
          height={222}
      ...
      <symbol id="thunderstorms-day_svg__h" viewBox="0 0 102.7 186.8">
        <path
          fill="url(#thunderstorms-day_svg__e)"
          stroke="#f6a823"
          strokeMiterlimit={10}
          strokeWidth={4}
    ...
    <use
      xlinkHref="#thunderstorms-day_svg__g"
      width={363}
      height={258}
      transform="translate(68 109)"
    />
    <use
      xlinkHref="#thunderstorms-day_svg__h"
      width={102.7}
      height={186.7}
