...
const SvgOvercastHail = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#overcast-hail_svg__a"
        id="overcast-hail_svg__h"
        x1={62.5}
        x2={74.5}
        y1={2.1}
        y2={22.9}
      ...
      <symbol
        id="overcast-hail_svg__n"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#overcast-hail_svg__d"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#overcast-hail_svg__e" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
    ...
    <use
      xlinkHref="#overcast-hail_svg__n"
      width={398}
      height={222}
      transform="translate(68.84 145)"
    />
    <use
      xlinkHref="#overcast-hail_svg__o"
      width={137}
      height={25}
...
export default SvgOvercastHail;
