...
const SvgExtremeDayRain = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#extreme-day-rain_svg__a"
        id="extreme-day-rain_svg__k"
        x1={1436.7}
        x2={1454.9}
        y1={-1137}
        y2={-1089.7}
      ...
      <symbol id="extreme-day-rain_svg__g" viewBox="0 0 196 196">
        <circle
          ...
          cy={98}
          r={40}
          fill="url(#extreme-day-rain_svg__b)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol id="extreme-day-rain_svg__e" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#extreme-day-rain_svg__c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="extreme-day-rain_svg__f" viewBox="0 0 350 222">
        <path
          fill="url(#extreme-day-rain_svg__d)"
          stroke="#5b6472"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="extreme-day-rain_svg__h"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#extreme-day-rain_svg__e"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#extreme-day-rain_svg__f" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol
        id="extreme-day-rain_svg__q"
        overflow="visible"
        viewBox="0 0 410.8 258"
      >
        <use xlinkHref="#extreme-day-rain_svg__g" width={196} height={196} />
        <use
          xlinkHref="#extreme-day-rain_svg__h"
          width={398}
          height={222}
    ...
    <use
      xlinkHref="#extreme-day-rain_svg__q"
      width={410.8}
      height={258}
      transform="translate(56 109)"
    />
    <use
      xlinkHref="#extreme-day-rain_svg__r"
      width={129}
      height={57}
...
export default SvgExtremeDayRain;
