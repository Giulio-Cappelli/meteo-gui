...
const SvgOvercastRain = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#overcast-rain_svg__a"
        id="overcast-rain_svg__h"
        x1={1436.7}
        x2={1454.9}
        y1={-1137}
        y2={-1089.7}
      ...
      />
      <symbol id="overcast-rain_svg__d" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#overcast-rain_svg__b)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="overcast-rain_svg__e" viewBox="0 0 350 222">
        <path
          fill="url(#overcast-rain_svg__c)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="overcast-rain_svg__n"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#overcast-rain_svg__d"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#overcast-rain_svg__e" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
    ...
    <use
      xlinkHref="#overcast-rain_svg__n"
      width={398}
      height={222}
      transform="translate(68.84 145)"
    />
    <use
      xlinkHref="#overcast-rain_svg__o"
      width={129}
      height={57}
...
export default SvgOvercastRain;
