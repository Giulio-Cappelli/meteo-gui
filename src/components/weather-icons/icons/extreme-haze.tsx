...
const SvgExtremeHaze = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#extreme-haze_svg__a"
        id="extreme-haze_svg__f"
        x1={107.3}
        x2={179.3}
        y1={-8.8}
        y2={115.9}
      ...
      <symbol id="extreme-haze_svg__k" overflow="visible" viewBox="0 0 398 222">
        ...
        <use xlinkHref="#extreme-haze_svg__e" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol id="extreme-haze_svg__l" overflow="visible" viewBox="0 0 264 72">
        <g>
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__a)"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
            d="M12 60h30"
          ...
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__f)"
          ...
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__g)"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
            d="M222 60h30"
        ...
        <g>
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__h)"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
            d="M12 12h30"
          ...
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__i)"
            strokeDasharray="60 60"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
          ...
          <path
            fill="none"
            stroke="url(#extreme-haze_svg__j)"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
            d="M222 12h30"
    ...
    <use
      xlinkHref="#extreme-haze_svg__k"
      width={398}
      height={222}
      transform="translate(68.84 145)"
    />
    <use
      xlinkHref="#extreme-haze_svg__l"
      width={264}
      height={72}
