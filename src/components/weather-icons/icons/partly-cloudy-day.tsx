...
const SvgPartlyCloudyDay = (props: any) => (
  <svg
  ...
  >
    <defs>
      <symbol id="partly-cloudy-day_svg__c" viewBox="0 0 196 196">
        <circle
          cx={98}
          cy={98}
          r={40}
          fill="url(#partly-cloudy-day_svg__a)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol id="partly-cloudy-day_svg__d" viewBox="0 0 350 222">
        <path
      ...
      <symbol id="partly-cloudy-day_svg__e" viewBox="0 0 363 258">
        <use xlinkHref="#partly-cloudy-day_svg__c" width={196} height={196} />
        <use
          xlinkHref="#partly-cloudy-day_svg__d"
          width={350}
          height={222}
    ...
    <use
      xlinkHref="#partly-cloudy-day_svg__e"
      width={363}
      height={258}
