...
const SvgExtreme = (props: any) => (
  ...
  >
    <defs>
      <symbol id="extreme_svg__c" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#extreme_svg__a)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="extreme_svg__d" viewBox="0 0 350 222">
        <path
          fill="url(#extreme_svg__b)"
          stroke="#5b6472"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol id="extreme_svg__e" overflow="visible" viewBox="0 0 398 222">
        <use
          xlinkHref="#extreme_svg__c"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#extreme_svg__d" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
