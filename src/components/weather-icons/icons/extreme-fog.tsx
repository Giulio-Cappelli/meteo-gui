...
const SvgExtremeFog = (props: any) => (
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#extreme-fog_svg__a"
        id="extreme-fog_svg__f"
        x2={168}
        y1={-50.4}
        y2={74.3}
      />
      ...
      <symbol id="extreme-fog_svg__g" overflow="visible" viewBox="0 0 398 222">
        ...
        <use xlinkHref="#extreme-fog_svg__e" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
    ...
    <use
      xlinkHref="#extreme-fog_svg__g"
      width={398}
      height={222}
      transform="translate(68.84 145)"
    />
    <use
      xlinkHref="#extreme-fog_svg__h"
      width={264}
      height={72}
