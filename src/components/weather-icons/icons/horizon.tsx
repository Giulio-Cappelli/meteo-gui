...
const SvgHorizon = (props: any) => (
  ...
  >
    <defs>
      ...
      <clipPath id="horizon_svg__b">
        <path fill="none" d="M0 0h512v306H0z" />
      </clipPath>
      <symbol id="horizon_svg__c" viewBox="0 0 384 384">
        <circle
          cx={192}
          cy={192}
          r={84}
          fill="url(#horizon_svg__a)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={6}
        />
    ...
    <g clipPath="url(#horizon_svg__b)">
      <use
        xlinkHref="#horizon_svg__c"
        width={384}
        height={384}
