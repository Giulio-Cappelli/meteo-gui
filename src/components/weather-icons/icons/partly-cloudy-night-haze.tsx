...
const SvgPartlyCloudyNightHaze = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-night-haze_svg__a"
        id="partly-cloudy-night-haze_svg__i"
        x1={107.3}
        x2={179.3}
        y1={-56.9}
        y2={67.9}
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-night-haze_svg__a"
        id="partly-cloudy-night-haze_svg__j"
        x1={174.8}
        x2={246.8}
        y1={-95.8}
        y2={28.9}
      ...
      <symbol id="partly-cloudy-night-haze_svg__d" viewBox="0 0 172 172">
        <path
      ...
      <symbol id="partly-cloudy-night-haze_svg__e" viewBox="0 0 350 222">
        <path
      ...
      <symbol id="partly-cloudy-night-haze_svg__k" viewBox="0 0 351 246">
        <use
          xlinkHref="#partly-cloudy-night-haze_svg__d"
          width={172}
          height={172}
        />
        <use
          xlinkHref="#partly-cloudy-night-haze_svg__e"
          width={350}
          height={222}
      ...
      <symbol
        id="partly-cloudy-night-haze_svg__l"
        overflow="visible"
        viewBox="0 0 264 72"
      >
        <g>
        ...
        <g>
          ...
          <path
            fill="none"
            stroke="url(#partly-cloudy-night-haze_svg__i)"
            strokeDasharray="60 60"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
          ...
          <path
            fill="none"
            stroke="url(#partly-cloudy-night-haze_svg__j)"
            strokeLinecap="round"
            strokeMiterlimit={10}
            strokeWidth={24}
            d="M222 12h30"
    ...
    <use
      xlinkHref="#partly-cloudy-night-haze_svg__k"
      width={351}
      height={246}
      transform="translate(80 121)"
    />
    <use
      xlinkHref="#partly-cloudy-night-haze_svg__l"
      width={264}
      height={72}
