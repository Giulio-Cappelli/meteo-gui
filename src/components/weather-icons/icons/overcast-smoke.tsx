...
const SvgOvercastSmoke = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <symbol id="overcast-smoke_svg__c" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#overcast-smoke_svg__a)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="overcast-smoke_svg__d" viewBox="0 0 350 222">
        <path
          fill="url(#overcast-smoke_svg__b)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="overcast-smoke_svg__k"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#overcast-smoke_svg__c"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#overcast-smoke_svg__d" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
    ...
    <use
      xlinkHref="#overcast-smoke_svg__k"
      width={398}
      height={222}
      transform="translate(68.84 145)"
    />
    <use
      xlinkHref="#overcast-smoke_svg__l"
      width={168}
      height={212}
...
export default SvgOvercastSmoke;
