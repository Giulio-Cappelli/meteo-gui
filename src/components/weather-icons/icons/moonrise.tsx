...
const SvgMoonrise = (props: any) => (
  ...
  >
    <defs>
      ...
      <clipPath id="moonrise_svg__b">
        <path
          fill="none"
          d="M512 306H304l-35.9-31.4a18.4 18.4 0 0 0-24.2 0L208 306H0V0h512Z"
        />
      </clipPath>
      <symbol id="moonrise_svg__c" viewBox="0 0 270 270">
        <path
          fill="url(#moonrise_svg__a)"
          stroke="#72b9d5"
          strokeLinecap="round"
    ...
    />
    <g clipPath="url(#moonrise_svg__b)">
      <use
        xlinkHref="#moonrise_svg__c"
        width={270}
        height={270}
