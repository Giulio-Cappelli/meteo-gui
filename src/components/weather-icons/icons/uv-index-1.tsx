...
const SvgUvIndex1 = (props: any) => (
  ...
  >
    <defs>
      ...
      <clipPath id="uv-index-1_svg__b">
        <path fill="none" d="M64 64h384v192H328a72 72 0 0 0-72 72v120H64Z" />
      </clipPath>
      <symbol id="uv-index-1_svg__c" viewBox="0 0 384 384">
        <circle
          cx={192}
          cy={192}
          r={84}
    ...
    <g clipPath="url(#uv-index-1_svg__b)">
      <use
        xlinkHref="#uv-index-1_svg__c"
        width={384}
        height={384}
    ...
    <path
      fill="#fff"
      d="M366.4 388h-19v-45h-17.8v-12.6h3q7.8 0 12.4-3.4 4.2-3.1 5.5-10.2l.2-.8h15.6Z"
    />
  </svg>
);
