...
const SvgPartlyCloudyNightRain = (props: any) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="partly-cloudy-night-rain_svg__c"
        x1={99.5}
        x2={232.6}
        y1={30.7}
        y2={261.4}
      ...
      <linearGradient
        id="partly-cloudy-night-rain_svg__b"
        x1={34.7}
        x2={119.2}
        y1={18.6}
        y2={165}
      ...
      <linearGradient
        id="partly-cloudy-night-rain_svg__a"
        x1={1381.3}
        x2={1399.5}
        y1={-1144.7}
        y2={-1097.4}
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-night-rain_svg__a"
        id="partly-cloudy-night-rain_svg__h"
        x1={1436.7}
        x2={1454.9}
        y1={-1137}
        y2={-1089.7}
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-night-rain_svg__a"
        id="partly-cloudy-night-rain_svg__k"
        x1={1492.1}
        x2={1510.3}
        y1={-1129.3}
        y2={-1082.1}
      ...
      />
      <symbol id="partly-cloudy-night-rain_svg__d" viewBox="0 0 172 172">
        <path
          fill="url(#partly-cloudy-night-rain_svg__b)"
          stroke="#72b9d5"
          strokeLinecap="round"
      ...
      <symbol id="partly-cloudy-night-rain_svg__e" viewBox="0 0 350 222">
        <path
          fill="url(#partly-cloudy-night-rain_svg__c)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol id="partly-cloudy-night-rain_svg__n" viewBox="0 0 351 246">
        <use
          xlinkHref="#partly-cloudy-night-rain_svg__d"
          width={172}
          height={172}
        />
        <use
          xlinkHref="#partly-cloudy-night-rain_svg__e"
          width={350}
          height={222}
    ...
    <use
      xlinkHref="#partly-cloudy-night-rain_svg__n"
      width={351}
      height={246}
      transform="translate(80 121)"
    />
    <use
      xlinkHref="#partly-cloudy-night-rain_svg__o"
      width={129}
      height={57}
