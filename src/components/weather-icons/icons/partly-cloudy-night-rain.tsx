...
const SvgPartlyCloudyNightRain = (props: any) => (
  ...
  >
    <defs>
      ...
      <linearGradient
        id="partly-cloudy-night-rain_svg__d"
        x1={29.53}
        x2={32.47}
        y1={42.95}
        y2={48.05}
      ...
      />
      <linearGradient
        id="partly-cloudy-night-rain_svg__e"
        x1={36.53}
        x2={39.47}
        y1={42.95}
        y2={48.05}
    ...
    <path
      fill="none"
      stroke="url(#partly-cloudy-night-rain_svg__a)"
      strokeLinecap="round"
      strokeMiterlimit={10}
      strokeWidth={2}
    ...
    <path
      fill="none"
      stroke="url(#partly-cloudy-night-rain_svg__d)"
      strokeLinecap="round"
      strokeMiterlimit={10}
      strokeWidth={2}
    ...
    <path
      fill="none"
      stroke="url(#partly-cloudy-night-rain_svg__e)"
      strokeLinecap="round"
      strokeMiterlimit={10}
      strokeWidth={2}
