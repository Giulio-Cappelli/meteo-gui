  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        id="partly-cloudy-day-hail_svg__h"
        x1={62.5}
        x2={74.5}
        y1={2.1}
        y2={22.9}
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-day-hail_svg__a"
        id="partly-cloudy-day-hail_svg__k"
        x1={118.5}
        x2={130.5}
        y1={2.1}
        y2={22.9}
      ...
      <symbol id="partly-cloudy-day-hail_svg__n" viewBox="0 0 363 258">
        <use
          xlinkHref="#partly-cloudy-day-hail_svg__d"
          width={196}
          height={196}
        />
        <use
          xlinkHref="#partly-cloudy-day-hail_svg__e"
          width={350}
          height={222}
    ...
    <use
      xlinkHref="#partly-cloudy-day-hail_svg__n"
      width={363}
      height={258}
      transform="translate(68 109)"
    />
    <use
      xlinkHref="#partly-cloudy-day-hail_svg__o"
      width={137}
      height={25}
