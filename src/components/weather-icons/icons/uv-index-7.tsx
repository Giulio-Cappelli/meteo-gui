...
const SvgUvIndex7 = (props: any) => (
  ...
  >
    <defs>
      ...
      <clipPath id="uv-index-7_svg__b">
        <path fill="none" d="M64 64h384v192H328a72 72 0 0 0-72 72v120H64Z" />
      </clipPath>
      <symbol id="uv-index-7_svg__c" viewBox="0 0 384 384">
        <circle
          cx={192}
          cy={192}
          r={84}
    ...
    <g clipPath="url(#uv-index-7_svg__b)">
      <use
        xlinkHref="#uv-index-7_svg__c"
        width={384}
        height={384}
    ...
    <path
      fill="#fff"
      d="M355.3 388h-20q0-13.7 6.5-29a88.4 88.4 0 0 1 17.9-26.7h-35.5V316h55.6v14.7q-12.3 13.1-18.2 26.8a81.8 81.8 0 0 0-6.3 30.5Z"
    />
  </svg>
);
