...
const SvgThermometerWarmer = (props: any) => (
  <svg
  ...
  >
    <defs>
      <symbol id="thermometer-warmer_svg__c" viewBox="0 0 72 168">
      ...
      <symbol id="thermometer-warmer_svg__d" viewBox="0 0 118 278">
        <path
      ...
      <symbol id="thermometer-warmer_svg__e" viewBox="0 0 118 278">
        <use
          xlinkHref="#thermometer-warmer_svg__c"
          width={72}
          height={168}
          transform="translate(23 87)"
        />
        <use xlinkHref="#thermometer-warmer_svg__d" width={118} height={278} />
      </symbol>
      <linearGradient
    ...
    <use
      xlinkHref="#thermometer-warmer_svg__e"
      width={118}
      height={278}
