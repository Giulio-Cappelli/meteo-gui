...
const SvgThunderstormsDayExtremeRain = (props: any) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="thunderstorms-day-extreme-rain_svg__c"
        x1={52.7}
        x2={133.4}
        y1={9.6}
        y2={149.3}
      ...
      <linearGradient
        id="thunderstorms-day-extreme-rain_svg__d"
        x1={99.5}
        x2={232.6}
        y1={30.7}
        y2={261.4}
      ...
      <linearGradient
        id="thunderstorms-day-extreme-rain_svg__q"
        x1={8.7}
        x2={80.9}
        y1={17.1}
        y2={142.1}
      ...
      <linearGradient
        id="thunderstorms-day-extreme-rain_svg__a"
        x1={1381.3}
        x2={1399.5}
        y1={-1144.7}
        y2={-1097.4}
      ...
      <linearGradient
        xlinkHref="#thunderstorms-day-extreme-rain_svg__a"
        id="thunderstorms-day-extreme-rain_svg__k"
        x1={1436.7}
        x2={1454.9}
        y1={-1137}
        y2={-1089.7}
      ...
      <linearGradient
        xlinkHref="#thunderstorms-day-extreme-rain_svg__a"
        id="thunderstorms-day-extreme-rain_svg__n"
        x1={1492.1}
        x2={1510.3}
        y1={-1129.3}
        y2={-1082.1}
      ...
      />
      <linearGradient
        id="thunderstorms-day-extreme-rain_svg__b"
        x1={78}
        x2={118}
        y1={63.4}
        y2={132.7}
      ...
      <symbol id="thunderstorms-day-extreme-rain_svg__g" viewBox="0 0 196 196">
        <circle
          ...
          cy={98}
          r={40}
          fill="url(#thunderstorms-day-extreme-rain_svg__b)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol
        id="thunderstorms-day-extreme-rain_svg__e"
        viewBox="0 0 200.3 126.1"
      >
        <path
          fill="url(#thunderstorms-day-extreme-rain_svg__c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="thunderstorms-day-extreme-rain_svg__f" viewBox="0 0 350 222">
        <path
          fill="url(#thunderstorms-day-extreme-rain_svg__d)"
          stroke="#5b6472"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="thunderstorms-day-extreme-rain_svg__h"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#thunderstorms-day-extreme-rain_svg__e"
          width={200.3}
          height={126.1}
        ...
        <use
          xlinkHref="#thunderstorms-day-extreme-rain_svg__f"
          width={350}
          height={222}
        >
          <animateTransform
      ...
      <symbol
        id="thunderstorms-day-extreme-rain_svg__r"
        overflow="visible"
        viewBox="0 0 410.8 258"
      >
        <use
          xlinkHref="#thunderstorms-day-extreme-rain_svg__g"
          width={196}
          height={196}
        />
        <use
          xlinkHref="#thunderstorms-day-extreme-rain_svg__h"
          width={398}
          height={222}
      ...
      <symbol
        id="thunderstorms-day-extreme-rain_svg__t"
        viewBox="0 0 102.7 186.8"
      >
        <path
          fill="url(#thunderstorms-day-extreme-rain_svg__q)"
          stroke="#f6a823"
          strokeMiterlimit={10}
          strokeWidth={4}
    ...
    <use
      xlinkHref="#thunderstorms-day-extreme-rain_svg__r"
      width={410.8}
      height={258}
      transform="translate(56 109)"
    />
    <use
      xlinkHref="#thunderstorms-day-extreme-rain_svg__s"
      width={129}
      height={57}
      transform="translate(191.5 343.5)"
    />
    <use
      xlinkHref="#thunderstorms-day-extreme-rain_svg__t"
      width={102.7}
      height={186.7}
...
export default SvgThunderstormsDayExtremeRain;
