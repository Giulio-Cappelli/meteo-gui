...
const SvgExtremeDayDrizzle = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        id="extreme-day-drizzle_svg__a"
        x1={1192.2}
        x2={1201.7}
        y1={817.6}
        y2={842.2}
        gradientTransform="rotate(-9 -2274.016 6929.567)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <linearGradient
        xlinkHref="#extreme-day-drizzle_svg__a"
        id="extreme-day-drizzle_svg__l"
        x1={1247.5}
        x2={1257}
        y1={826.3}
        y2={851}
      ...
      <symbol id="extreme-day-drizzle_svg__g" viewBox="0 0 196 196">
        <circle
          ...
          cy={98}
          r={40}
          fill="url(#extreme-day-drizzle_svg__b)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol id="extreme-day-drizzle_svg__e" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#extreme-day-drizzle_svg__c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="extreme-day-drizzle_svg__f" viewBox="0 0 350 222">
        <path
          fill="url(#extreme-day-drizzle_svg__d)"
          stroke="#5b6472"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="extreme-day-drizzle_svg__h"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#extreme-day-drizzle_svg__e"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#extreme-day-drizzle_svg__f" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol
        id="extreme-day-drizzle_svg__i"
        overflow="visible"
        viewBox="0 0 410.8 258"
      >
        <use xlinkHref="#extreme-day-drizzle_svg__g" width={196} height={196} />
        <use
          xlinkHref="#extreme-day-drizzle_svg__h"
          width={398}
          height={222}
    ...
    <use
      xlinkHref="#extreme-day-drizzle_svg__i"
      width={410.8}
      height={258}
...
export default SvgExtremeDayDrizzle;
