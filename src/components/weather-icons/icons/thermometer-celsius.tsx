...
const SvgThermometerCelsius = (props: any) => (
  ...
  >
    <defs>
      <symbol id="thermometer-celsius_svg__e" viewBox="0 0 109.1 73.2">
        <path
          fill="#374151"
      ...
      <symbol id="thermometer-celsius_svg__c" viewBox="0 0 72 168">
      ...
      <symbol id="thermometer-celsius_svg__d" viewBox="0 0 118 278">
        <path
      ...
      <symbol id="thermometer-celsius_svg__f" viewBox="0 0 118 278">
        <use
          xlinkHref="#thermometer-celsius_svg__c"
          width={72}
          height={168}
          transform="translate(23 87)"
        />
        <use xlinkHref="#thermometer-celsius_svg__d" width={118} height={278} />
      </symbol>
      <linearGradient
    ...
    <use
      xlinkHref="#thermometer-celsius_svg__e"
      width={109.1}
      height={73.2}
      transform="translate(314 250)"
    />
    <use
      xlinkHref="#thermometer-celsius_svg__f"
      width={118}
      height={278}
