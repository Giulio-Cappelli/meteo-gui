...
const SvgWindOnshore = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#wind-onshore_svg__a"
        id="wind-onshore_svg__b"
        x1={31.4}
        x2={68.3}
        y1={37.6}
        y2={101.4}
      ...
      <symbol id="wind-onshore_svg__g" viewBox="0 0 138 96">
        <path
          fill="none"
          stroke="url(#wind-onshore_svg__a)"
          strokeDasharray={58}
          strokeLinecap="round"
          strokeMiterlimit={10}
          strokeWidth={12}
        ...
        <path
          fill="none"
          stroke="url(#wind-onshore_svg__b)"
          strokeDasharray={43}
          strokeLinecap="round"
          strokeMiterlimit={10}
          strokeWidth={12}
