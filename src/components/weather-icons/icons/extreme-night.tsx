...
const SvgExtremeNight = (props: any) => (
  <svg
  ...
  >
    <defs>
      <symbol
        id="extreme-night_svg__f"
        overflow="visible"
        viewBox="0 0 172 172"
      >
        <path
          fill="url(#extreme-night_svg__a)"
          stroke="#72b9d5"
          strokeLinecap="round"
      ...
      <symbol id="extreme-night_svg__d" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#extreme-night_svg__b)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="extreme-night_svg__e" viewBox="0 0 350 222">
        <path
          fill="url(#extreme-night_svg__c)"
          stroke="#5b6472"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="extreme-night_svg__g"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#extreme-night_svg__d"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#extreme-night_svg__e" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol
        id="extreme-night_svg__h"
        overflow="visible"
        viewBox="0 0 398.8 246"
      >
        <use xlinkHref="#extreme-night_svg__f" width={172} height={172} />
        <use
          xlinkHref="#extreme-night_svg__g"
          width={398}
          height={222}
    ...
    <use
      xlinkHref="#extreme-night_svg__h"
      width={398.8}
      height={246}
...
export default SvgExtremeNight;
