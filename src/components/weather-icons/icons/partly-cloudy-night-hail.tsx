...
const SvgPartlyCloudyNightHail = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        id="partly-cloudy-night-hail_svg__f"
        x1={62.5}
        x2={74.5}
        y1={2.1}
        y2={22.9}
      ...
      <linearGradient
        xlinkHref="#partly-cloudy-night-hail_svg__a"
        id="partly-cloudy-night-hail_svg__i"
        x1={118.5}
        x2={130.5}
        y1={2.1}
        y2={22.9}
      ...
      <linearGradient
        ...
        y2={165}
      />
      <symbol id="partly-cloudy-night-hail_svg__d" viewBox="0 0 172 172">
        <path
      ...
      <symbol id="partly-cloudy-night-hail_svg__e" viewBox="0 0 350 222">
        <path
      ...
      <symbol id="partly-cloudy-night-hail_svg__n" viewBox="0 0 351 246">
        <use
          xlinkHref="#partly-cloudy-night-hail_svg__d"
          width={172}
          height={172}
        />
        <use
          xlinkHref="#partly-cloudy-night-hail_svg__e"
          width={350}
          height={222}
    ...
    <use
      xlinkHref="#partly-cloudy-night-hail_svg__n"
      width={351}
      height={246}
      transform="translate(80 121)"
    />
    <use
      xlinkHref="#partly-cloudy-night-hail_svg__o"
      width={137}
      height={25}
