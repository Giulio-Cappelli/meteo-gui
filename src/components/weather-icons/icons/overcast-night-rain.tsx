...
const SvgOvercastNightRain = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#overcast-night-rain_svg__a"
        id="overcast-night-rain_svg__k"
        x1={1436.7}
        x2={1454.9}
        y1={-1137}
        y2={-1089.7}
      ...
      />
      <symbol id="overcast-night-rain_svg__g" viewBox="0 0 172 172">
        <path
          fill="url(#overcast-night-rain_svg__b)"
          stroke="#72b9d5"
          strokeLinecap="round"
      ...
      <symbol id="overcast-night-rain_svg__e" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#overcast-night-rain_svg__c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="overcast-night-rain_svg__f" viewBox="0 0 350 222">
        <path
          fill="url(#overcast-night-rain_svg__d)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="overcast-night-rain_svg__h"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#overcast-night-rain_svg__e"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#overcast-night-rain_svg__f" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol
        id="overcast-night-rain_svg__q"
        overflow="visible"
        viewBox="0 0 398.8 246"
      >
        <use xlinkHref="#overcast-night-rain_svg__g" width={172} height={172} />
        <use
          xlinkHref="#overcast-night-rain_svg__h"
          width={398}
          height={222}
    ...
    <use
      xlinkHref="#overcast-night-rain_svg__q"
      width={398.8}
      height={246}
      transform="translate(68 121)"
    />
    <use
      xlinkHref="#overcast-night-rain_svg__r"
      width={129}
      height={57}
...
export default SvgOvercastNightRain;
