...
const SvgOvercastDayHail = (props: any) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        xlinkHref="#overcast-day-hail_svg__a"
        id="overcast-day-hail_svg__k"
        x1={62.5}
        x2={74.5}
        y1={2.1}
        y2={22.9}
      ...
      <symbol id="overcast-day-hail_svg__g" viewBox="0 0 196 196">
        <circle
          ...
          cy={98}
          r={40}
          fill="url(#overcast-day-hail_svg__b)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={4}
        />
      ...
      <symbol id="overcast-day-hail_svg__e" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#overcast-day-hail_svg__c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="overcast-day-hail_svg__f" viewBox="0 0 350 222">
        <path
          fill="url(#overcast-day-hail_svg__d)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol
        id="overcast-day-hail_svg__h"
        overflow="visible"
        viewBox="0 0 398 222"
      >
        <use
          xlinkHref="#overcast-day-hail_svg__e"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#overcast-day-hail_svg__f" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol
        id="overcast-day-hail_svg__q"
        overflow="visible"
        viewBox="0 0 410.8 258"
      >
        <use xlinkHref="#overcast-day-hail_svg__g" width={196} height={196} />
        <use
          xlinkHref="#overcast-day-hail_svg__h"
          width={398}
          height={222}
    ...
    <use
      xlinkHref="#overcast-day-hail_svg__q"
      width={410.8}
      height={258}
      transform="translate(56 109)"
    />
    <use
      xlinkHref="#overcast-day-hail_svg__r"
      width={137}
      height={25}
...
export default SvgOvercastDayHail;
