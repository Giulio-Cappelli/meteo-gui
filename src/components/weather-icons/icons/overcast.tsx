...
const SvgOvercast = (props: any) => (
  ...
  >
    <defs>
      <symbol id="overcast_svg__c" viewBox="0 0 200.3 126.1">
        <path
      ...
      <symbol id="overcast_svg__d" viewBox="0 0 350 222">
        <path
      ...
      <symbol id="overcast_svg__e" overflow="visible" viewBox="0 0 398 222">
        <use
        ...
        <use xlinkHref="#overcast_svg__d" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
