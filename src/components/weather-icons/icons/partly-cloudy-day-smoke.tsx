...
const SvgPartlyCloudyDaySmoke = (props) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        id="partly-cloudy-day-smoke_svg__c"
        x1={22.56}
        x2={39.2}
        y1={21.96}
        y2={50.8}
      ...
      <linearGradient
        id="partly-cloudy-day-smoke_svg__d"
        x1={23.5}
        x2={28}
        y1={38.1}
        y2={45.9}
        xlinkHref="#partly-cloudy-day-smoke_svg__a"
      />
      <linearGradient
    ...
    <path
      fill="url(#partly-cloudy-day-smoke_svg__c)"
      stroke="#e6effc"
      strokeMiterlimit={10}
      strokeWidth={0.5}
    ...
    <circle
      ...
      cy={51}
      r={4.5}
      fill="url(#partly-cloudy-day-smoke_svg__d)"
      stroke="#afb4bc"
      strokeMiterlimit={10}
      strokeWidth={0.5}
    >
    ...
    <circle
      ...
      cy={51}
      r={6}
      fill="url(#partly-cloudy-day-smoke_svg__e)"
      stroke="#afb4bc"
      strokeMiterlimit={10}
      strokeWidth={0.5}
    >
